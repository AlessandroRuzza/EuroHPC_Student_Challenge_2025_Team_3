...
def branch_and_bound(graph, time_limit=10000):
    ...
    while queue:
        ...
        if doBranch1:
            ...
            if lb1 < best_ub:
                heapq.heappush(queue, (ub1, BranchAndBoundNode(uf1, edges1, lb1, ub1, coloring, node.depth+1)))
        ...
        if lb2 < best_ub:
            heapq.heappush(queue, (ub2, BranchAndBoundNode(uf2, edges2, lb2, ub2, coloring, node.depth+1)))
